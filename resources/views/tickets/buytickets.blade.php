            ...
            @php
                $tickets = [
                    ...
                    [
                        ...
                        'description' =>
                            'Package of 15 games per hour and 150 points awarded to those with an account.',
                        'price' => '1500 KSH',
                    ],
                    [
                        'video' => 'groupz.mp4',
                        'title' => 'Group package',
                        'description' =>
                            'Package of 13 games per hour and 130 points awarded to those with an account.',
                        'price' => '1250 KSH',
                    ],
                ];
            @endphp
                ...
                <div class="col-md-3 mb-4">
                    <div class="card ticket-card">
                        <div class="card-img-container">
                            <video src="{{ asset('assets/images/' . $ticket['video']) }}" class="card-img-top" autoplay muted
                                loop></video>
                        </div>
                        <div class="card-body d-flex flex-column">
                            ...
                            <div class="mt-auto">
                                ...
                                <div class="quantity-selector d-flex align-items-center">
                                    <button class="quantity-btn minus btn btn-outline-secondary"
                                        data-id="{{ $index }}"> - </button>
                                    <input type="number" id="quantity{{ $index }}"
                                        class="quantity-input form-control mx-2 text-center" value="1" min="1"
                                        max="10" style="width: 60px;">
                                    <button class="quantity-btn plus btn btn-outline-secondary"
                                        data-id="{{ $index }}">+</button>
                                </div>
                                <a href="#" class="btn btn-primary mt-2 w-100 add-to-cart" data-ticket-type="{{ $ticket['title'] }}">Add to Cart</a>
    ...
    <script>
        ...
        function updateSelectedTicketsView() {
            ...
            selectedTickets.forEach(ticket => {
                html +=
                    `<li>${ticket.title} - Quantity: ${ticket.quantity} - Total Price: ${ticket.totalPrice}</li>`;
            });
            html += '</ul>';
        ...
        $(document).ready(function() {
            ...
            $('.apply-promo-code').click(function(e) {
                ...
                $('#promo-code-result').html(
                    `<p>Promo code <strong>${promoCode}</strong> applied successfully!</p>`);
            });
